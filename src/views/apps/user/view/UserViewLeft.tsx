          ...
          <Card>
            ...
            <CardContent>
              ...
              <Box sx={{ pt: 2, pb: 1 }}>
                ...
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                  <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Fecha de Registro:</Typography>
                  <Typography variant='body2'>23/11/23</Typography>
                </Box>
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                  <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Contacto:</Typography>
                  <Typography variant='body2'>+591 {data.contact}</Typography>
                </Box>
              </Box>
            </CardContent>
